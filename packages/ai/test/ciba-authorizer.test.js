...
describe('CIBAAuthorizer#authorize', () => {
  ...
  }) // should request authorization with scope
  ...
  it('should request authorization with scope and single ACR value', async () => {
    ...
    expect(x).toEqual('1c266114-a1be-4252-8ad1-04986c5b9ac1')
  }) // should request authorization with scope and single ACR value
  
  it('should authenticate with client secret using basic authentication scheme', async () => {
    vi.stubGlobal('fetch', vi.fn(() => {
      return Promise.resolve({
        ok: true,
        json: () => {
    ...
    expect(x).toEqual('1c266114-a1be-4252-8ad1-04986c5b9ac1')
  }) // should authenticate with client secret using basic authentication scheme
